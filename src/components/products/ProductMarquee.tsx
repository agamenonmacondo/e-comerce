        ...
        <div className="marquee-content flex animate-marquee whitespace-nowrap py-4">
          {marqueeProducts.map((product, index) => (
            <div
              ...
              className="marquee-item mx-4 w-80 md:w-96 flex-shrink-0 transform transition-all duration-300 hover:scale-105 hover:z-10 group"
            >
              <Link
                href={`/products/${product.id}`}
                className="block relative h-[500px] w-full rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 bg-card"
